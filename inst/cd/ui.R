...
,
tags$footer("Funding Support: The Wellcome Trust/DBT India Alliance grant IA/CPHE/14/1/501504; tavsethi@stanford.edu; rlodha1661@gmail.com;"  , align = "center", style = "
            position:absolute;
            bottom:0;
            width:100%;
            height:30px;
